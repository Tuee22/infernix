...
single-accelerator (apple-silicon) plus `linux-cpu` cohort sign-off pending
[Wave W](cohort-validation-waves.md) (Stage 1 GREEN; apple Stage 2 behavioral GREEN). On 2026-07-22 the
