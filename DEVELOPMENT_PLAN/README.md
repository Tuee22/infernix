...
guard, and a memory-exhaustion classification. Wave R proved the full Apple per-model never-OOM
rerun (paired 4.26/6.37), and Wave S (2026-07-09) closed the current rebuilt `linux-cpu` and
`linux-gpu` full-suite residuals.
...
| 4 | Inference Service and Durable Runtime | Done — Sprints 4.25 (matrix substrate-accuracy) and 4.26 (apple-silicon inference RAM admission) are closed. Wave R (2026-07-08) proved the full Apple 16-model integration lane with **zero OS OOM-kill** and routed per-model Playwright over real UI output; Wave S (2026-07-09) closed the rebuilt `linux-cpu` and `linux-gpu` full suites. Closing evidence: CPU image `sha256:cfcd0c617a70919a1d083b43dfa66e9041b215a27a176ab82c2d806a36cf7627` passed `./bootstrap/linux-cpu.sh test`; GPU image `sha256:31e076d62e5aab45d0f0894fcac86e634f1850aa46ae4611258f8ae3fab2ad66` plus engine images `pytorch` `sha256:978779650affd4490b16913216fed83c7f942112da23d152eb1acd58b26b1585`, `diffusers` `sha256:5643d7fdd17e599503328f6476d3a4d8dc1cc8d65c751fa2a1abaa5960ee25a0`, and `vllm` `sha256:9be7ac2a614e235bcb346e4f9e4ff0433e7183bed7cfc170501d86d13ea21a61` passed `./bootstrap/linux-gpu.sh test` with integration PASS and routed Playwright `15/15`. The prior Wave O MT3 catalog replacement (Sprint 4.22) is **closed** — proven by Wave P (2026-07-04). | [phase-4-inference-service-and-durable-runtime.md](phase-4-inference-service-and-durable-runtime.md) |
...
| 6 | Validation, E2E, and HA Hardening | Done — Sprints 6.36 (real-output + matrix validation hardening) and 6.37 (apple-silicon memory-bounded validation lane, unblocked by Phase 4 Sprint 4.26) are closed. Wave R (2026-07-08) proved the Apple 16-model per-model `test integration` with zero OS OOM-kill plus routed per-model Playwright with the `Chat.purs` `data-inline-output` real-text marker and picker catalog-completeness guard. Wave S (2026-07-09) closed rebuilt `linux-cpu` and `linux-gpu` full suites: CPU image `sha256:cfcd0c617a70919a1d083b43dfa66e9041b215a27a176ab82c2d806a36cf7627` passed `./bootstrap/linux-cpu.sh test`; GPU image `sha256:31e076d62e5aab45d0f0894fcac86e634f1850aa46ae4611258f8ae3fab2ad66` plus engine images `pytorch` `sha256:978779650affd4490b16913216fed83c7f942112da23d152eb1acd58b26b1585`, `diffusers` `sha256:5643d7fdd17e599503328f6476d3a4d8dc1cc8d65c751fa2a1abaa5960ee25a0`, and `vllm` `sha256:9be7ac2a614e235bcb346e4f9e4ff0433e7183bed7cfc170501d86d13ea21a61` passed `./bootstrap/linux-gpu.sh test` with integration PASS and routed Playwright `15/15`. The prior Wave O expanded-MT3 integration/e2e gate (Sprint 6.35) is **closed** — proven by Wave P (2026-07-04). | [phase-6-validation-e2e-and-ha-hardening.md](phase-6-validation-e2e-and-ha-hardening.md) |
