...
| 2 | Kind Cluster Storage and Lifecycle | Done — Managed-State-Transition Doctrine reopen (Sprint 2.14 code-side closed 2026-07-16: typed ClusterLifecycle machine, fail-closed versioned aeson persistence, and WriterQuiesced lease-gated teardown; cohort gate closed by [Wave V](cohort-validation-waves.md) (2026-07-20)); prior Done (Sprints 2.10-2.13 lifecycle, retained-state, bootstrap-boundary, and host-manifest closure validated by Apple Wave A and CUDA Linux Wave C) | [phase-2-kind-cluster-storage-and-lifecycle.md](phase-2-kind-cluster-storage-and-lifecycle.md) |
