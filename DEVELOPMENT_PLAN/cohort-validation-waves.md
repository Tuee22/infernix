...
The historical closed rows remain unchanged. Wave Y and AA are Done; Waves Z and AB remain open.
...
| 8 | Validation-only work remains, plus unstarted Sprint 8.11 (`Planned`, no blocker) and Sprint 8.12 (`Blocked` on a fleet validation topology); Wave AB remains queued |
