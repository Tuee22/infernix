...
Wave J, Wave L, Wave M, and Wave N closures, plus the open Wave O MT3 catalog replacement follow-on.
...
7.28 generated artifact ownership. Wave O is open for the `music-mt3-infer` and `music-mr-mt3`
post-replacement full-suite proof.
...
| 4 | Sprints 4.1-4.21/4.23/4.24 `Done`; Sprint 4.22 is active for the 2026-06-30 `music-mt3-infer` / `music-mr-mt3` catalog replacement proof | Original contract closed in Wave A; per-family real-output closed in Wave I on the selected `linux-gpu` accelerator plus `linux-cpu` for the then-active catalogs; engine-pool routing closed in Wave J; physical Apple multi-host proof is hardware-deferred; post-replacement Apple MT3 proof is not claimed | Wave O is open: full rebuilt-image `linux-cpu` plus selected `linux-gpu` integration and routed Playwright must prove both new MT3 rows |
...
| 6 | Sprints 6.1-6.34 `Done`; Sprint 6.35 is active for the expanded MT3 catalog integration/e2e gate | Original coverage closed in Wave A/A.1/A.2/A.3; per-family routed real-output closed in Wave I for the then-active catalogs; engine-pool validation closed in Wave J; physical Apple multi-host proof is hardware-deferred; post-replacement Apple MT3 proof is not claimed | Wave O is open: full rebuilt-image `linux-cpu` plus selected `linux-gpu` integration and routed Playwright must exercise the expanded MT3 catalog |
