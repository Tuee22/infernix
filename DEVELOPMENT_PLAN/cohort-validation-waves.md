...
| 4 | Sprints 4.1-4.24 `Done` (Sprint 4.22 MT3 catalog replacement closed by Wave P on 2026-07-04); Sprint 4.25 `[Planned]` for the Wave Q matrix substrate-accuracy reopen | Original contract closed in Wave A; per-family real-output closed in Wave I on the selected `linux-gpu` accelerator plus `linux-cpu` for the then-active catalogs; engine-pool routing closed in Wave J; physical Apple multi-host proof is hardware-deferred; post-replacement Apple MT3 proof is not claimed | Wave P (2026-07-04) proved both MT3 rows on rebuilt `linux-cpu` + `linux-gpu` full-suite; the Wave Q Sprint 4.25 CUDA GPU-accuracy rows are the remaining `linux-gpu` residual |
...
| 6 | Sprints 6.1-6.35 `Done` (Sprint 6.35 expanded MT3 gate closed by Wave P on 2026-07-04); Sprint 6.36 `[Planned]` for the Wave Q real-output + matrix validation hardening | Original coverage closed in Wave A/A.1/A.2/A.3; per-family routed real-output closed in Wave I for the then-active catalogs; engine-pool validation closed in Wave J; physical Apple multi-host proof is hardware-deferred; post-replacement Apple MT3 proof is not claimed | Wave P (2026-07-04) exercised the expanded MT3 catalog on rebuilt `linux-cpu` + `linux-gpu` full-suite; the Wave Q Sprint 6.36 CUDA-only accuracy rows are the remaining `linux-gpu` residual |
