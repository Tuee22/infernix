...
- the shared lifecycle now exposes `lifecycleStatus`, `lifecyclePhase`, `lifecycleDetail`, and
  ...
  promotion. Sprint 2.15 (closed by Wave X, 2026-07-24) adds the persisted `ClusterOwner`
