...
- the canonical HA-failure coverage currently lives in `infernix test integration`
...
- the Apple host-native final-substrate lane is the currently validated HA-failure path
