...
REQUIRED_PHRASES = {
    Path("chart/values.yaml"): ["runtimeMode:", "upstreamCharts:", "harbor:", "minio:", "pulsar:", "platformPortals:", "catalogPayload:", "publication:", "30002", "30011", "30080", "30650", "/api", "/harbor", "/minio/console", "/pulsar/admin", "storageClass: infernix-manual", "storageClassName: infernix-manual"],
    Path("chart/templates/deployment-service.yaml"): ["demoConfig.mountPath", "INFERNIX_DEMO_CONFIG_PATH", "INFERNIX_PUBLICATION_STATE_PATH", "INFERNIX_ROUTE_PROBE_BASE_URL", "INFERNIX_MINIO_ENDPOINT", "INFERNIX_PULSAR_ADMIN_URL", "INFERNIX_PULSAR_WS_BASE_URL", "runtimeClassName: nvidia", "infernix.runtime/gpu", "nvidia.com/gpu"],
    ...
    Path("kind/cluster-linux-cuda.yaml"): ["nvidia-container-runtime", "infernix.runtime/gpu=true", "/etc/containerd/certs.d", "./.build/kind/registry", "containerPort: 30080", "containerPort: 30650"],
